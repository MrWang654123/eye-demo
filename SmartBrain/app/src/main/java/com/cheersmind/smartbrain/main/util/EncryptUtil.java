...
//    }
    ...
    public static String encryptHMac256(String content, String key) {
        ...
        try {
            ...
            //resultString = Base64.encodeToString(digest,Base64.DEFAULT);
            resultString = new String(Base64.encode(digest,Base64.DEFAULT));
        } catch (Exception e) {
            System.out.println("encryptMD5 fail");
        }
     ...
     * @return
     */
    public static String encryptMD5_QS(String content) {
        String resultString = "";
//        String appkey = "fdjf,jkgfkl";
        String appkey = "r7_m4@0w,oV9p#Hi";
