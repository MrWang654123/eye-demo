...
import com.cheersmind.smartbrain.main.view.CustomDialog;
    ...
    protected void initWebView() {
        ...
        webView.setWebViewClient(new WebViewClient() {
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                WebViewBaseActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(WebViewBaseActivity.this,"页面加载失败",Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
