 ...
 * “我的收藏”recycler适配器
 */
public class MineFavoriteRecyclerAdapter extends BaseQuickAdapter<SimpleArticleEntity, BaseViewHolder> {

    private Context context;

    public MineFavoriteRecyclerAdapter(Context context, int layoutResId, @Nullable List<SimpleArticleEntity> data) {
