 ...
 * 正在进行的测评
 */
public class ExamDoingFragment extends LazyLoadFragment {
...
//        recyclerItem = new ArrayList<>();
    ...
    private void refreshChildTopList() {
        ...
        DataRequestService.getInstance().loadChildTopicListByStatus(defaultChildId,Dictionary.TOPIC_STATUS_INCOMPLETE,
