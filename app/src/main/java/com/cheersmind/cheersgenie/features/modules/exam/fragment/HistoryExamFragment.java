...
public class HistoryExamFragment extends LazyLoadFragment {
            ...
            try {
                ...
                if (item != null) {
                    ...
                    if (status == Dictionary.TASK_STATUS_COMPLETE) {
                        if (getActivity() != null) {
                            ToastUtil.showShort(getActivity().getApplication(), "已完成");
                        }
    ...
    public void onInitView(View contentView) {
        ...
        divider.setDrawable(ContextCompat.getDrawable(getContext(),R.drawable.recycler_divider_ffffff_15dp));
            ...
            public void onResponse(Object obj) {
                try {
                    ...
                    if (recyclerAdapter.getData().size() >= totalCount) {
                        //全部加载结束
                        if (recyclerAdapter.getData().size() < Dictionary.HIDE_HISTORY_EXAM_LOAD_MORE_VIEW_COUNT) {
