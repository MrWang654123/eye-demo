...
import com.cheersmind.cheersgenie.features_v2.adapter.MinePracticeRecyclerAdapter;
...
import com.cheersmind.cheersgenie.features_v2.entity.PracticeRootEntity;
import com.cheersmind.cheersgenie.features_v2.modules.mine.activity.MinePracticeActivity;
import com.cheersmind.cheersgenie.features_v2.modules.mine.activity.MinePracticeItemActivity;
 ...
 * 我的实践
 */
public class MinePracticeFragment extends LazyLoadFragment {
    ...
    //适配器的数据列表
    MinePracticeRecyclerAdapter recyclerAdapter;
    ...
    BaseQuickAdapter.OnItemClickListener recyclerItemClickListener = new BaseQuickAdapter.OnItemClickListener() {
        ...
        public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
            PracticeEntity entity = recyclerAdapter.getData().get(position);
            MinePracticeItemActivity.startMinePracticeItemActivity(getContext(), entity);
        }
    };
    ...
    protected int setContentView() {
        return R.layout.fragment_mine_practice;
    }
    ...
    protected void onInitView(View rootView) {
        ...
        //适配器
        recyclerAdapter = new MinePracticeRecyclerAdapter(getContext(), R.layout.recycleritem_mine_practice, null);
...
//        recyclerAdapter.openLoadAnimation(BaseQuickAdapter.SLIDEIN_BOTTOM);
        ...
        //设置无数据提示文本
        emptyLayout.setNoDataTip(getResources().getString(R.string.empty_tip_mine_practice));
...
//        }
    ...
    @OnClick({R.id.fabAddPractice})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            //添加实践
            case R.id.fabAddPractice: {
                if (getActivity() != null) {
                    ToastUtil.showShort(getActivity().getApplication(), "添加实践");
                }
                break;
            }
        }
        ...
        DataRequestService.getInstance().getArticles(dto, new BaseService.ServiceCallback() {
            ...
            public void onResponse(Object obj) {
                try {
                    ...
                    PracticeRootEntity rootEntity = InjectionWrapperUtil.injectMap(dataMap, PracticeRootEntity.class);

                    totalCount = rootEntity.getTotal();
                    List<PracticeEntity> dataList = rootEntity.getItems();
