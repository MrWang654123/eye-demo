 ...
 * 发展档案
 */
public class TrackRecordEntity implements Serializable, MultiItemEntity {
    ...
    //无数据情况推荐
    public static final int TYPE_NO_DATA_RECOMMEND = 3;

    //显示项类型
    private int itemType = TYPE_COMMON_ITEM;
