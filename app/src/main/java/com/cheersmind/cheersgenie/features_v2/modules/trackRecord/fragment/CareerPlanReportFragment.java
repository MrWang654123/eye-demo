...
public class CareerPlanReportFragment extends LazyLoadFragment {
    ...
    private String testTopicId = "001c8858-86a7-11e8-b880-161768d3f949";
    private String testChildExamId = "162956c7-812c-4946-b9db-96274941cd43";
    ...
    protected void onInitView(View rootView) {
        ...
        try {
            ...
            if (bundle != null) {
                ...
                topicInfo.setTopicId(testTopicId);
                TopicInfoChildEntity childTopic = new TopicInfoChildEntity();
                childTopic.setChildExamId(testChildExamId);
        ...
        //设置无数据提示文本
        emptyLayout.setNoDataTip(getResources().getString(R.string.empty_tip_career_plan_report));
        //重载监听
                            ...
                            for (final SimpleArticleEntity article : dataList) {
                                ...
                                if (!TextUtils.isEmpty(url)) {
                                    if (!url.equals(ivMain.getTag(R.id.iv_main))) {
                                        Glide.with(CareerPlanReportFragment.this)
                                                .load(url)
