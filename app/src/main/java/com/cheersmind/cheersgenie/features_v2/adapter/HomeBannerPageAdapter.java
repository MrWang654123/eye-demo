...
//    private static RequestOptions defaultOptions;
    ...
    public HomeBannerPageAdapter(Fragment fragment, List<HomeBanner> list) {
...
//        initRequestOptions(fragment);
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        HomeBanner entity = list.get(position);
...
//                .into(ivMain);
        ivMain.setImageURI(entity.getImg_url());
