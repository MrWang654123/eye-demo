...
public class QsLineChartView extends DemoView implements Runnable{
    ...
    public QsLineChartView(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        initView();
    }

    public QsLineChartView(Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
    }

    public QsLineChartView(Context context, AttributeSet attrs, int defStyle) {
